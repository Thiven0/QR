...
const SideBarGuard = () => {
    return (
        <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-15 pl-1 pb-30 " aria-label="Sidebar">
            <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-[#E5E7EB] py-4 rounded-md">
                <ul className="space-y-2 font-medium">
                    <li>
                        <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-[#99a1af] hover:bg-gray-100 dark:hover:bg-gray-700 group">
